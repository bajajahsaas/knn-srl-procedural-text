...
python -u train.py --model_path models/copy_max_pooling.pt --plot_path logscopy --no-generate --copy --traindata $mnt/exact/data/train.pkl --valdata $mnt/exact/data/val.pkl --batch_size 16 --gpu
#sleep 1
exit
