...
for per in 0.01 0.03 0.06 0.1 0.3 0.6; do
    python -u test_k.py --generate --no-copy --valdata /mnt/nfs/work1/mccallum/abajaj/akbc/data/scibert-ret-exp-train/exp-k-test/new/small/val${per}.pkl --model_path models/wtlabs_gen${per}.pt --test_output_path generate --gpu
    python -u test_k.py --generate --no-copy --valdata /mnt/nfs/work1/mccallum/abajaj/akbc/data/scibert-ret-exp-train/exp-k-test/new/small/test${per}.pkl --model_path models/wtlabs_gen${per}.pt --test_output_path generate --gpu
done
