...
python -u test.py --no-generate --copy --valdata /mnt/nfs/work1/mccallum/abajaj/akbc/data/scibert-ret-exp-train/exp-k-test/new/val1_k40.pkl --model_path models/copy1.pt --test_output_path copy --gpu
