...
# python -u test.py --no-generate --copy --valdata val1_k40.pkl --model_path models/copy1.pt --test_output_path copy
...
# python -u test.py --no-generate --copy --valdata val2_k40.pkl --model_path models/copy2.pt --test_output_path copy
...
# python -u test.py --no-generate --copy --valdata val5_k40.pkl --model_path models/copy5.pt --test_output_path copy
...
# python -u test.py --no-generate --copy --valdata val10_k40.pkl --model_path models/copy10.pt --test_output_path copy
