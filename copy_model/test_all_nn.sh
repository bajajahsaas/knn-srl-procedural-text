...
python -u test_k.py --no-generate --copy --valdata testk30.pkl --model_path models/copy.pt --test_output_path copy_test
...
python -u test_k.py --no-generate --copy --valdata testk40.pkl --model_path models/copy.pt --test_output_path copy_test
...
python -u test_k.py --no-generate --copy --valdata testk50.pkl --model_path models/copy.pt --test_output_path copy_test
