...
for k in 5 40 10 15 20 30 50; do 
    python -u test_k.py --no-generate --copy --valdata $mnt/exact/data/test_k${k}.pkl --model_path models/copy_max_pooling.pt --test_output_path copy_test --gpu
    python -u test_k.py --no-generate --copy --valdata $mnt/exact/data/val_k${k}.pkl --model_path models/copy_max_pooling.pt --test_output_path copy_test --gpu
done
