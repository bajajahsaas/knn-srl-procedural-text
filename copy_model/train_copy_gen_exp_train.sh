...
python -u train.py --traindata train1.pkl --valdata val1.pkl --model_path models/copygen1.pt --plot_path logscopygen_exp_train/1  --gpu
python -u train.py --traindata train2.pkl --valdata val2.pkl --model_path models/copygen2.pt --plot_path logscopygen_exp_train/2  --gpu
