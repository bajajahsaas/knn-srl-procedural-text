...
for per in (1 2 5 10 20 50); do
    python copy_model/prepare_data.py materials_train${per}.json scibert train_embeddings${per}.pkl
    python copy_model/prepare_context.py original${per}.annoy original_bert.pkl train_embeddings${per}.pkl train_embeddings${per}.pkl train${per}.pkl scibert 8 5
...
# K = 40
# python copy_model/prepare_context.py original1.annoy original_bert.pkl train_embeddings1.pkl val_embeddings.pkl val1_k40.pkl scibert 8 40

# python copy_model/prepare_context.py original2.annoy original_bert.pkl train_embeddings2.pkl val_embeddings.pkl val2_k40.pkl scibert 8 40

# python copy_model/prepare_context.py original5.annoy original_bert.pkl train_embeddings5.pkl val_embeddings.pkl val5_k40.pkl scibert 8 40

# python copy_model/prepare_context.py original10.annoy original_bert.pkl train_embeddings10.pkl val_embeddings.pkl val10_k40.pkl scibert 8 40

# python copy_model/prepare_context.py original20.annoy original_bert.pkl train_embeddings20.pkl val_embeddings.pkl val20_k40.pkl scibert 8 40
#
#python copy_model/prepare_context.py original50.annoy original_bert.pkl train_embeddings50.pkl val_embeddings.pkl val50_k40.pkl scibert 8 40
#python copy_model/prepare_context.py original100.annoy original_bert.pkl train_embeddings100.pkl val_embeddings.pkl val100_k40.pkl scibert 8 40
