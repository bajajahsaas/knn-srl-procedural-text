...
python copy_model/prepare_data.py wetlabs_train001.json scibert train_embeddings001.pkl
python copy_model/prepare_data.py wetlabs_train003.json scibert train_embeddings003.pkl
python copy_model/prepare_data.py wetlabs_train006.json scibert train_embeddings006.pkl
python copy_model/prepare_data.py wetlabs_train01.json scibert train_embeddings01.pkl
python copy_model/prepare_data.py wetlabs_train03.json scibert train_embeddings03.pkl
python copy_model/prepare_data.py wetlabs_train06.json scibert train_embeddings06.pkl
...
# K = 5
for per in 001 003 006 01 03 06; do
